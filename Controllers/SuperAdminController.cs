...
namespace TMS.Controllers
{
    public class SuperAdminController : Controller
    {
        ...
        public void SendEmailVerificationLink(string emailId, string activationCode, string userpassowrd, string emailFor = "VerifyAccount")
        {
            ...
            var verifyUrl = "/https://TMIS.azurewebsites.net/Users/" + emailFor + "/" + activationCode;
            var link = verifyUrl;
            var fromEmail = new MailAddress("kenethyiga@gmail.com", "UPF TASK MANAGEMENT");
            var toEmail = new MailAddress(emailId);
            //this password is generated by u in ur email account
            var fromEmailPassword = "cvzvxjmvwarnprmh";
